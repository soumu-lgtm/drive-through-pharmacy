-- =============================================================
-- プロトタイプ2 用 Supabase セットアップ（デモ専用テーブル）
...
insert into public.rsv2_reservations (code, cs_id, slot_id, rdate, rtime, name, kana, phone, visit_type, menu_id, channel) values
 ('SEED0001', 11, '11_'||to_char(current_date,'YYYY-MM-DD')||'_09:00', to_char(current_date,'YYYY-MM-DD'), '09:00', '佐藤 一郎', 'サトウ イチロウ', '090-1111-2222', 'REVISIT', null, 'WEB'),
 ('SEED0002', 11, '11_'||to_char(current_date,'YYYY-MM-DD')||'_09:00', to_char(current_date,'YYYY-MM-DD'), '09:00', '鈴木 花子', 'スズキ ハナコ', '090-3333-4444', 'FIRST', null, 'PHONE'),
 ('SEED0003', 13, '13_'||to_char(current_date+1,'YYYY-MM-DD')||'_10:30', to_char(current_date+1,'YYYY-MM-DD'), '10:30', '田中 美咲', 'タナカ ミサキ', '080-5555-6666', 'FIRST', 101, 'WEB');
