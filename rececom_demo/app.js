...
// ===== Config =====
// GAS API disabled for demo
const API_URL = '';
// Auth stubs (auth.js removed)
function handleLogin() {}
function handleLogout() {}
function handleGoogleLogin() {}
function openUserManager() {}
function initSupabase() { return Promise.resolve(false); }
function saveToSupabase() { return Promise.resolve({ success: false }); }
function stockBadge() { return ''; }

// ===== Demo Data (all names/addresses are fictional) =====
const patients = [
  { id:'D001', name:'山田一郎', age:75, sex:'男', insurance:'後期高齢者1割', ratio:0.1, dob:'1951-04-10', address:'東京都千代田区霞が関1-1-1', phone:'03-0000-0001', nameKana:'ヤマダイチロウ', allergies:['ペニシリン系'], history:['本態性高血圧症','2型糖尿病'], prevRx:[{drugId:'amlodipine5',qty:1,unit:'T'},{drugId:'metformin500',qty:2,unit:'T'}], prevDays:28, prevVisitDate:'2026-05-10', vehicle:{plate:'品川 500 あ 00-01',lane:1}, status:'active', memo:'デモ患者。定期処方。', insurancePhoto:null, insuranceNumber:'記号00001-番号001', insurerNumber:'39130010', kouhiNumber:'', incomeLevel:'ippan', questionnaire:null, arrivedAt:'09:00', visitDate:'2026-06-10', pastKartes:[{date:'2026-05-10',cc:'定期処方',diag:'本態性高血圧症, 2型糖尿病',rx:'アムロジピン5mg 1T, メトホルミン500mg 2T 28日',doc:'担当医A'}], pastVitals:[{date:'2026-05-10',t:'36.2',bp:'132/78',spo2:'97',p:'68'}] },
  { id:'D002', name:'佐藤花子', age:45, sex:'女', insurance:'社保3割', ratio:0.3, dob:'1981-08-15', address:'東京都新宿区西新宿2-8-1', phone:'03-0000-0002', nameKana:'サトウハナコ', allergies:[], history:['アレルギー性鼻炎'], prevRx:[{drugId:'montelukast10',qty:1,unit:'T'}], prevDays:14, prevVisitDate:'2026-05-27', vehicle:{plate:'品川 300 い 00-02',lane:2}, status:'waiting', memo:'', insurancePhoto:null, insuranceNumber:'', questionnaire:{receivedAt:'2026-06-10 09:30',symptoms:'鼻閉、くしゃみ',duration:'3日前から',temperature:'36.4',otherComplaints:'目のかゆみ'}, arrivedAt:'09:15', visitDate:'2026-06-10', pastKartes:[{date:'2026-05-27',cc:'鼻閉',diag:'アレルギー性鼻炎',rx:'モンテルカスト10mg 1T 14日',doc:'担当医A'}], pastVitals:[{date:'2026-05-27',t:'36.4',bp:'118/72',spo2:'99',p:'76'}] },
  { id:'D003', name:'鈴木次郎', age:3, sex:'男', insurance:'乳幼児医療', ratio:0.0, dob:'2023-02-20', address:'東京都渋谷区道玄坂1-1-1', phone:'03-0000-0003', nameKana:'スズキジロウ', allergies:[], history:[], prevRx:[], prevDays:5, prevVisitDate:'2026-06-03', vehicle:{plate:'品川 500 う 00-03',lane:3}, status:'waiting', memo:'小児。体重14kg。', insurancePhoto:null, insuranceNumber:'', questionnaire:{receivedAt:'2026-06-10 09:40',symptoms:'発熱、咳嗽',duration:'昨日から',temperature:'38.2',otherComplaints:'食欲低下'}, arrivedAt:'09:25', visitDate:'2026-06-10', pastKartes:[{date:'2026-06-03',cc:'発熱',diag:'急性上気道炎',rx:'カロナール細粒 0.3g 5日',doc:'担当医B'}], pastVitals:[{date:'2026-06-03',t:'37.8',bp:'',spo2:'98',p:'110'}] },
  { id:'D004', name:'高橋美咲', age:68, sex:'女', insurance:'国保2割', ratio:0.2, dob:'1958-06-01', address:'東京都品川区大井1-1-1', phone:'03-0000-0004', nameKana:'タカハシミサキ', allergies:['セフェム系'], history:['変形性膝関節症'], prevRx:[{drugId:'loxoprofen60',qty:3,unit:'T'},{drugId:'rebamipide100',qty:3,unit:'T'}], prevDays:14, prevVisitDate:'2026-05-27', vehicle:{plate:'品川 300 え 00-04',lane:4}, status:'waiting', memo:'膝関節注射検討中。', insurancePhoto:null, insuranceNumber:'', questionnaire:null, arrivedAt:'09:40', visitDate:'2026-06-10', pastKartes:[{date:'2026-05-27',cc:'膝痛',diag:'変形性膝関節症',rx:'ロキソプロフェン60mg 3T, レバミピド100mg 3T 14日',doc:'担当医A'}], pastVitals:[{date:'2026-05-27',t:'36.3',bp:'142/86',spo2:'96',p:'72'}] },
  { id:'D005', name:'中村健太', age:32, sex:'男', insurance:'社保3割', ratio:0.3, dob:'1994-12-25', address:'東京都中央区銀座4-1-1', phone:'03-0000-0005', nameKana:'ナカムラケンタ', allergies:[], history:['腰痛症'], prevRx:[{drugId:'loxoprofen60',qty:3,unit:'T'}], prevDays:7, prevVisitDate:'2026-06-03', vehicle:{plate:'品川 300 お 00-05',lane:5}, status:'waiting', memo:'', insurancePhoto:null, insuranceNumber:'', questionnaire:null, arrivedAt:'09:55', visitDate:'2026-06-10', pastKartes:[{date:'2026-06-03',cc:'腰痛',diag:'腰痛症',rx:'ロキソプロフェン60mg 3T 7日',doc:'担当医B'}], pastVitals:[] }
];
...
renderDiseaseQuickBtns();
renderPatientList();
// DB/Auth disabled for demo - show app directly
if (document.getElementById('loginOverlay')) document.getElementById('loginOverlay').style.display = 'none';
if (document.getElementById('appContainer')) document.getElementById('appContainer').style.display = '';
updateRevisionBadge();
applyExamCollapse();
